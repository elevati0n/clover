...
module.exports = ({ reporter }, options) => {
  ...
  const contentDirectory =
    options.contentDirectory || path.join(".", "content");
...
function getContentDirectoryTree(root) {
  return {
    ...
    aboutSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.AboutSection
    ),
    contactSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.ContactSection
    ),
    heroSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.HeroSection
    ),
    interestsSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.InterestsSection
    ),
    legalSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.LegalSection
    ),
    projectsSection: path.join(
      root,
      ContentFolder.Sections,
      ContentFolder.ProjectsSection
    ),
  };
}
...
function getExampleFiles(directory) {
  ...
  return {
    ...
    contactSection: {
      ...
      example: path.join(
        exampleDirectory["contactSection"],
    ...
    interestsSection: {
      ...
      example: path.join(
        exampleDirectory["interestsSection"],
    ...
    projectsSection: {
      ...
      example: path.join(
        exampleDirectory["projectsSection"],
